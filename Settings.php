          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <!-- Recent Devices -->
                <div class="card mb-4" style="max-height: 300px; overflow-y: auto;">
                  <h5 class="card-header">Recent Devices Logins</h5>
                    ...
                    <table class="table border-top">
                      <thead>
                        <tr>
                          ...
                          <th class="text-truncate">Recent Login Activity</th>
                        </tr>
                      </thead>
