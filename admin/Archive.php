        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mt-4" style="max-height: 400px; overflow-y: auto;">
              ...
              <div class="table-responsive text-nowrap">
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0" id="NewsTable">
                    <!-- Data will be loaded here via AJAX -->
                  </tbody>
                </table>
            ...
            <script>
              ...
              function searchTableNews() {
                let input = document.getElementById("searchInputNews").value.toLowerCase();
              ...
              function searchTableLeader() {
                let input = document.getElementById("searchInputLeader").value.toLowerCase();
                let table = document.getElementById("LeadershipTable");
                let rows = table.getElementsByTagName("tr");
              ...
              function searchTableDoc() {
                let input = document.getElementById("searchInputDoc").value.toLowerCase();
