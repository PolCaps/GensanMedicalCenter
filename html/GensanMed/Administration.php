...
<head>
  ...
  <title>Gensan Medical Center | Administration</title>
      ...
      <div class="container">
        ...
        <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-4">
          ...
          <div class="app-academy-md-50 card-body d-flex align-items-md-center flex-column text-md-center mt-5">
            ...
            <p class="mb-3"> With expertise and leadership, our administration efficiently manages operations to ensure
              quality services. </p>
            ...
            <div class="d-flex"> <a class="btn btn-sm btn-label-primary mt-2 mx-3" aria-current="page"
                href="BoardDirectors.php">Board of
                Directors</a>
    ...
    <div class="container">
      ...
      <div class="row gy-5">
        ...
        $query = "SELECT CONCAT_WS(' ', first_name, middle_name, last_name) AS full_name, 
          ...
          FROM leaderships 
          WHERE type = 'administration' AND status ='active'";
