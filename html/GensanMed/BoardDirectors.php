...
<head>
  ...
  <title>Gensan Medical Center | Board of Directors</title>
      ...
      <div class="container">
        ...
        <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-4">
          ...
          <div class="app-academy-md-50 card-body d-flex align-items-md-center flex-column text-md-center mt-5">
            ...
            <p class="mb-3"> With strategic vision and leadership, our Board of Directors guides the organization to
              ensure excellence and growth. </p>
            ...
            <div class="d-flex">
              <a class="btn btn-sm btn-label-primary mt-2 mx-3" aria-current="page" href="MedicalServices.php">Medical
                Services
              </a>
    ...
    <div class="container">
      ...
      <div class="row gy-5">
        ...
        $query = "SELECT CONCAT_WS(' ', first_name, middle_name, last_name) AS full_name, 
          ...
          FROM leaderships 
          WHERE type = 'directors' AND status ='active'";
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mb-3 mt-lg-0 shadow-none">
            <div class="bg-label-success position-relative team-image-box">
              <img src="' . $imgPath . '" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
            </div>
