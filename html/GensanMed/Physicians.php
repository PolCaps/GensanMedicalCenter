    ...
    <div class="container">
      ...
      <div class="row gy-5">
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mb-3 mt-lg-0 shadow-none">
            <div class="bg-label-success position-relative team-image-box">
              <img src="../../assets/GMC_Photos/RemoTito.png"
                class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
            </div>
            <div class="card-body border border-top-0 border-label-success text-center">
              <h5 class="card-title mb-0"><strong>Remo-Tito Aguilar</strong></h5>
              <a class="btn btn-sm btn-label-primary mt-2" aria-current="page" href="#">Orthopaedics</a>
              <h6 class="card-title mt-2"><strong><i>Clinic: N/A</i></strong></h6>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mb-3 mt-lg-0 shadow-none">
            <div class="bg-label-success position-relative team-image-box">
              <img src="../../assets/GMC_Photos/Physicians/ALBORETE(HALF)-Photoroom.png"
                class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
            </div>
            <div class="card-body border border-top-0 border-label-success text-center">
              <h5 class="card-title mb-0"><strong>Alborote, Wright</strong></h5>
              <a class="btn btn-sm btn-label-primary mt-2" aria-current="page" href="#">Pediatrics</a>
              <h6 class="card-title mt-2"><strong><i>Clinic: N/A</i></strong></h6>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mb-3 mt-lg-0 shadow-none">
            <div class="bg-label-success position-relative team-image-box">
              <img src="../../assets/GMC_Photos/Physicians/CANCEL AGAD (HALF BODY)1-Photoroom.png"
                class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
            </div>
            <div class="card-body border border-top-0 border-label-success text-center">
              <h5 class="card-title mb-0"><strong>Cancel, Alan</strong></h5>
              <a class="btn btn-sm btn-label-primary mt-2" aria-current="page" href="#">Anesthesiology</a>
              <h6 class="card-title mt-2"><strong><i>Clinic: N/A</i></strong></h6>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mb-3 mt-lg-0 shadow-none">
            <div class="bg-label-success position-relative team-image-box">
              <img src="../../assets/GMC_Photos/Physicians/DrLim(nobg).png"
                class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
            </div>
            <div class="card-body border border-top-0 border-label-success text-center">
              <h5 class="card-title mb-0"><strong>Sherwyn, Lim</strong></h5>
              <a class="btn btn-sm btn-label-primary mt-2" aria-current="page" href="#">Radiology</a>
              <h6 class="card-title mt-2"><strong><i>Clinic: N/A</i></strong></h6>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mb-3 mt-lg-0 shadow-none">
            <div class="bg-label-success position-relative team-image-box">
              <img src="../..//assets/GMC_Photos/Physicians/SANDIG (HALF)-Photoroom.png"
                class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
            </div>
            <div class="card-body border border-top-0 border-label-success text-center">
              <h5 class="card-title mb-0"><strong>Leadership</strong></h5>
              <a class="btn btn-sm btn-label-primary mt-2" aria-current="page" href="#">See More</a>
              <h6 class="card-title mt-2"><strong><i>Clinic: N/A</i></strong></h6>
            </div>
          </div>
        </div>
