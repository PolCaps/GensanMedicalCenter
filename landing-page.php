        ...
        <div class="hero-text-box text-center">
          ...
          <div class="custom-swiper-container">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/s/1.png')">
              </div>
              <!-- <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/10.png')">
              </div> -->

              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/s/2.png')">
              </div>

              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/s/3.png')">
              </div>
              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/s/4.png')">
              </div>
              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/s/5.png')">
              </div>
              <!-- <div class="swiper-slide custom-swiper-slide"
                style="background-image:url('assets/GMC_Photos/Ginyard.png')"></div>
              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/6.png')">
              </div>
              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/7.png')">
              </div>
              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/8.png')">
              </div>

              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/9.png')">
              </div>
              <div class="swiper-slide custom-swiper-slide" style="background-image:url('assets/GMC_Photos/19.png')">
              </div> -->
        ...
        <div class="row mx-2 my-2">
          <div class="col-md-4 col-lg-4">
            <div class="card text-center mb-1">
              <div class="card-body">
                <p class=" ti ti-tada ti-lg ti-phone-call text-primary"></p>
                  ...
                  <div class="card-body text-center">
                    ...
                    <h3 class="my-2">106</h5>
                      <p><b class="text-primary">Medical Professionals</b> trained in specific areas of healthcare.
                        ...
                        healing.</p>
                      <a class="btn btn-sm btn-label-primary" aria-current="page" href="Physicians.php">See More</a>
                  </div>
                </div>
              </div>
                ...
                <!-- <script>
                  document.addEventListener("DOMContentLoaded", function () {
                    var swiper = new Swiper("#swiper-reviews", {
                      slidesPerView: 5,
                      spaceBetween: 20,
                      centeredSlides: true, // Center slides to avoid gaps
                      loop: true,
          ...
          <div class="col-lg-9 col-md-8 col-12">
            <div class="tab-content py-0">
                  ...
                  <div class="card accordion-item active">
                    ...
                    <div id="accordionBilling-1" class="accordion-collapse collapse show">
                      <div class="accordion-body">
                        ...
                        You can also pay at the hospital cashier.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="tab-pane fade" id="facilities" role="tabpanel">
                ...
                <!-- Facilities Tabs -->
                <div class="nav nav-tabs" id="facilityTabs" role="tablist">
                  <a class="nav-link active" id="rooms-tab" data-bs-toggle="tab" href="#rooms" role="tab">Rooms and
                    Accommodation</a>
                  <a class="nav-link" id="nursing-tab" data-bs-toggle="tab" href="#nursing" role="tab">Nursing
                    Station</a>
                  <a class="nav-link" id="er-tab" data-bs-toggle="tab" href="#er" role="tab">Emergency Room</a>
                  <a class="nav-link" id="icu-tab" data-bs-toggle="tab" href="#icu" role="tab">ICU</a>
                  <a class="nav-link" id="nicu-tab" data-bs-toggle="tab" href="#nicu" role="tab">NICU</a>
                  <a class="nav-link" id="or-tab" data-bs-toggle="tab" href="#or" role="tab">Operating & Delivery
                    Room</a>
                  <a class="nav-link" id="lab-tab" data-bs-toggle="tab" href="#lab" role="tab">Medical Laboratory</a>
                  <a class="nav-link" id="radiology-tab" data-bs-toggle="tab" href="#radiology" role="tab">Radiology &
                    Imaging</a>
                  <a class="nav-link" id="dietary-tab" data-bs-toggle="tab" href="#dietary" role="tab">Dietary
                    Department</a>
                  <a class="nav-link" id="rehab-tab" data-bs-toggle="tab" href="#rehab" role="tab">Rehab & Wellness
                    Center</a>
                  <a class="nav-link" id="outpatient-tab" data-bs-toggle="tab" href="#outpatient" role="tab">Outpatient
                    Facility</a>
                  <a class="nav-link" id="renal-tab" data-bs-toggle="tab" href="#renal" role="tab">Renal Dialysis</a>
                  <a class="nav-link" id="chapel-tab" data-bs-toggle="tab" href="#chapel" role="tab">Roman Catholic
                    Chapel</a>
                  <a class="nav-link" id="prayer-tab" data-bs-toggle="tab" href="#prayer" role="tab">Islamic Prayer
                    Room</a>
                </div>

                <!-- Facilities Content -->
                <div class="tab-content my-2" id="facilityTabsContent">
                  <div class="tab-pane fade show active" id="rooms" role="tabpanel">
                    Comfortable and well-equipped rooms for patient care.
                  </div>
                  <div class="tab-pane fade" id="nursing" role="tabpanel">
                    Centralized nursing stations for patient monitoring.
                  </div>
                  <div class="tab-pane fade" id="er" role="tabpanel">
                    24/7 emergency medical services.
                  </div>
                  <div class="tab-pane fade" id="icu" role="tabpanel">
                    Advanced care for critically ill patients.
                  </div>
                  <div class="tab-pane fade" id="nicu" role="tabpanel">
                    Specialized care for newborns in critical condition.
                  </div>
                  <div class="tab-pane fade" id="or" role="tabpanel">
                    State-of-the-art surgical and delivery rooms.
                  </div>
                  <div class="tab-pane fade" id="lab" role="tabpanel">
                    Comprehensive diagnostic laboratory services.
                  </div>
                  ...
                  <div class="tab-pane fade" id="dietary" role="tabpanel">
                    Nutritious meals prepared for patients and staff.
                  </div>
                  <div class="tab-pane fade" id="rehab" role="tabpanel">
                    Therapy and rehabilitation for patient recovery.
                  </div>
                  <div class="tab-pane fade" id="outpatient" role="tabpanel">
                    Consultation and treatment for non-admitted patients.
                  </div>
                  <div class="tab-pane fade" id="renal" role="tabpanel">
                    Dialysis services for renal care.
                  </div>
                  <div class="tab-pane fade" id="chapel" role="tabpanel">
                    A peaceful place for prayer and reflection.
                  </div>
                  <div class="tab-pane fade" id="prayer" role="tabpanel">
                    Dedicated prayer space for Muslim visitors.
                  </div>
                </div>
              </div>
